    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Pantau tren belanja, alokasi pengeluaran bulanan, dan kontrol pemborosan.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StatCard
          ...
          amount={maxExpenseCategory?.name ?? "Belum ada data"}
          ...
          <div className="h-64">
            {!hasTrend ? (
              <EmptyState
                ...
                description="Tambahkan transaksi pengeluaran untuk melihat tren bulanan."
              />
            ) : (
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Tooltip
                    ...
                    formatter={(v: number) => [formatIDR(v), "Pengeluaran"]}
                  />
                  <Bar
                    dataKey="amount"
                    fill="#F85149"
        ...
        <Card className="p-5 flex flex-col">
          ...
          {categoryBreakdown.length === 0 ? (
            <EmptyState
              ...
              description="Pengeluaran berkategori akan tampil di sini."
              size="sm"
            />
          ) : (
            <>
              ...
              <p className="text-[10px] text-muted-foreground mt-4 border-t border-border pt-2">
                Menampilkan kontribusi 5 kategori pengeluaran teratas.
              </p>
            </>
          )}
        </Card>
      ...
      <Card className="p-5">
        ...
        {transactions.length === 0 ? (
          <EmptyState
            ...
            description="Catat pengeluaran untuk melihat distribusi belanja Anda."
            size="sm"
          />
        ) : (
          <>
                ...
                <tbody className="divide-y divide-border">
                  {transactions.map((tx) => (
                    ...
                    >
                      ...
                      <td className="py-3 text-right font-mono tabular-nums text-expense font-semibold">
                        -{formatIDR(tx.amount)}
                      </td>
                    </tr>
                  ))}
            ...
            <ul className="md:hidden divide-y divide-border">
              {transactions.map((tx) => (
                <li key={tx.id} className="py-3 flex items-start gap-3">
                  ...
                  <p className="text-sm font-mono tabular-nums text-expense font-semibold whitespace-nowrap shrink-0">
                    -{formatIDR(tx.amount)}
                  </p>
                </li>
              ))}
